    ...
    document.querySelectorAll("#PesanansTable .btn-warning").forEach((btn) => {
        btn.addEventListener("click", function () {
            ...
            document.getElementById("produkIdEdit").value =
                this.dataset.produkId;
            document.getElementById("pengirimIdEdit").value =
                this.dataset.pengirimId;
            document.getElementById("namaPenerimaEdit").value =
                this.dataset.namaPenerima;
            document.getElementById("alamatPenerimaEdit").value =
                this.dataset.alamatPenerima;
            document.getElementById("notelpPenerimaEdit").value =
                this.dataset.notelpPenerima;
            document.getElementById("catatanPenerimaEdit").value =
        ...
        axios
            ...
            .then((res) => {
                Swal.fire({
                    ...
                    title: "Berhasil",
                    text:
                        res.data.message ?? "Data pesanan berhasil diperbarui",
                    timer: 1500,
                ...
                axios
                    ...
                    .then((res) => {
                        Swal.fire({
                            ...
                            title: "Berhasil",
                            text:
                                res.data.message ?? "Pesanan berhasil dihapus",
                            timer: 1500,
                            showConfirmButton: false,
                        }).then(() => location.reload());
                    })
