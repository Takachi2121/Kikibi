...
@section('subtitle', 'Tambah Pesanan di sini.')
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <p class="fw-semibold fs-4 mb-0">Tambah Data Pesanan</p>
                </div>
                <div class="col-md-6 text-end align-self-center">
                    <a href="{{ route('admin-pesanan') }}" class="btn btn-secondary mb-3">
                        <i class="fa-solid fa-arrow-left"></i> Kembali
                    </a>
                </div>
            </div>

            <form method="POST" enctype="multipart/form-data" id="tambahPesananForm" data-url="{{ route('pesanan-action.store') }}">
                @csrf
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <label class="form-label fw-bold mt-md-3 mt-sm-3 mb-3">Data Pesanan</label>

                        <div class="mb-3">
                            <label for="nama_pengirim" class="form-label">Nama Pengirim</label>
                            <select name="nama_pengirim" id="nama_pengirim" class="form-select">
                                <option value="" disabled hidden selected>Pilih Nama Pengirim</option>
