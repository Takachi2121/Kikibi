...
@section('subtitle', 'Edit Produk di sini.')
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <p class="fw-semibold fs-4 mb-0">Edit Data Produk</p>
                </div>
            ...
            <form id="editProdukForm" enctype="multipart/form-data" method="POST" data-url="{{ route('produk-action.update', $produk->id) }}">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="deskripsi_produk" style="min-height: 155px" name="deskripsi_produk">{{ $produk->deskripsi }}</textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <input type="number" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 2);" class="form-control" id="umur_min" name="umur_min" max="99" min="0" value="{{ $produk->umur_min }}">
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <input type="number" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 2);" class="form-control" id="umur_max" name="umur_max" max="99" min="0" value="{{ $produk->umur_max }}">
                                    <span class="input-group-text">Tahun</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="btn-group w-100" role="group">
                                <input type="radio" class="btn-check" name="gender" id="laki" value="Pria" autocomplete="off" {{ $produk->untuk_gender == 'Pria' ? 'checked' : '' }}>
                                <label class="btn btn-outline-primary" for="laki">
                                    <i class="fa-solid fa-mars me-1"></i> Laki-laki
                                </label>

                                <input type="radio" class="btn-check" name="gender" id="perempuan" value="Wanita" autocomplete="off" {{ $produk->untuk_gender == 'Wanita' ? 'checked' : '' }}>
                                <label class="btn btn-outline-danger" for="perempuan">
                                    <i class="fa-solid fa-venus me-1"></i> Perempuan
                                </label>

                                <input type="radio" class="btn-check" name="gender" id="unisex" value="Unisex" autocomplete="off" {{ $produk->untuk_gender == 'Unisex' ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="untuk_momen" name="untuk_momen" value="{{ $produk->untuk_momen }}">
                        </div>
                        <div class="mb-3"></div>
                        ...
                        <div class="col-lg-6 col-md-12">
                                ...
                                <div class="col-6">
                                    <div class="card shadow-sm h-100 text-center p-2">
                                        ...
                                        <img id="preview_foto_{{ $i }}"
                                            src="{{ $produk->{'foto_' . $i} ? asset('assets/img/Produk/'  . $produk->{'foto_' . $i}) : '' }}"
                            ...
                            <div class="d-flex justify-content-end mt-3">
                                <button type="submit" class="btn btn-danger w-auto" id="btnEditProduk">
                                    <span class="btn-text"><i class="fa-solid fa-save me-1"></i> Ubah Produk</span>
